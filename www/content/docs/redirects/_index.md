...
Hedgerules reads the `_redirects` file (generated by the Hugo template) and creates KVS entries:
...
These are written to `_redirects` by the Hugo template and read by Hedgerules.
